...
<html lang="pl">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ">
        ...
        <li class="nav-item dropdown">
                      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Języki</a>
                      <div class="dropdown-menu pows">
                          <a href="#" class="dropdown-item pow">Angielski</a>
                        </div>
                      </li>
    ...
    <div class="jumbotron">
      <img src="pic1.jpg" id="pic1" class="img-fluid">
      <h2>Z naszym kursem nauczysz się angielskiego zawodowego!</h2>
    </div>
